...
;// CONCATENATED MODULE: ./src/js/components/Post.js
...
class Post {
  ...
  getElement(el) {
    ...
    <div class="post-main">
        ...
        <div class="date-wrap">
            <span class="date">${moment_default()().format("DD.MM.YY")} 
            ${moment_default()().hour()}:${moment_default()().minutes()}</span>
        </div>
    </div>
...
;// CONCATENATED MODULE: ./src/images/microphone.png
const microphone_namespaceObject = __webpack_require__.p + "047ec023e0eb03b91b23.png";
;// CONCATENATED MODULE: ./src/images/camera.png
const camera_namespaceObject = __webpack_require__.p + "5fc9c0c9dc16e296f90b.png";
...
;// CONCATENATED MODULE: ./src/js/components/Creator.js
...
;// CONCATENATED MODULE: ./src/js/components/FormAPI.js
class FormAPI {
  constructor(element) {
    this.form = element;
...
;// CONCATENATED MODULE: ./src/js/components/TooltipAPI.js
...
class TooltipAPI {
  ...
  showTooltip(data) {
    ...
    tooltipEl.style.left = `${left + element.offsetWidth / 2 - tooltipEl.offsetWidth / 2 + 10}px`;
...
;// CONCATENATED MODULE: ./src/js/components/formatcoords.js
...
;// CONCATENATED MODULE: ./src/js/components/ValidatorAPI.js
...
;// CONCATENATED MODULE: ./src/js/components/TimerAPI.js
class TimerAPI {
  constructor() {
    this.minutes = null;
    this.seconds = null;
...
;// CONCATENATED MODULE: ./src/js/components/RecorderAPI.js
class RecorderAPI {
...
class TimeLine {
  ...
  init() {
    ...
    <div class="timeline-footer">
        ...
        <div class="btns">
                <button class="microphone btn"><img src="${microphone_namespaceObject}" alt="кнопка записи аудио" class="mirco logo"></button>
                <button class="camera btn"><img src="${camera_namespaceObject}" alt="кнопка записи видео" class="camera logo"></button>
        </div>    
    </div>`;
  ...
  async getAudio() {
    try {
      ...
      const {
        element,
        audio
      } = this.creatorAPI.audioRecord;
      this.activeEl = element;
      this.recordAPI.startRecord({
        stream,
        recorder,
        audio
      });
...
const timeLine = new TimeLine("wrapper");
timeLine.init();
